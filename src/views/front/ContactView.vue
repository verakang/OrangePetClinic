<template>
  <section>
    <div class="contact_banner position-relative">
      <img src="../../assets/img/contact-banner.jpg" class="w-100" alt="contact banner">
      <h2 class="text-center mb-7 fst-italic position-absolute top-50 start-50 translate-middle text-secondary">聯絡我們<span class="display-2 d-none d-lg-inline-block">/Contact Us</span></h2>
    </div>
    <div class="contact_content container bg-light px-5 py-7 rounded-4 shadow-sm mb-10">
